...
export function ScannerDesk() {
  ...
  return <div className="page-wrap"><header className="page-header"><div><span className="eyebrow">Captura móvil</span><h1>Escáner de documentos</h1><p>Abra la cámara desde el celular y guarde un PDF multipágina en la biblioteca.</p></div></header>
